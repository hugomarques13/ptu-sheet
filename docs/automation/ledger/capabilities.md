# capabilities — automation ledger

[← LEDGER](../LEDGER.md)

<a id="capabilities-01"></a>
## `capabilities-01` — Ability / item / stat swaps, Weather & Terrain, Action economy & AP, Movement, push & switching +2 more

P3 · 25 open of 25 · open

- 🔴 **Forme Change** — `todo` · P3 · themes: swap, stat
...
- 🔴 **Milk Collection** — `todo` · P3 · themes: swap, action, stat
...
- 🔴 **Mushroom Harvest** — `todo` · P3 · themes: swap, action, stat
...
- 🔴 **Viral Fusion** — `todo` · P3 · themes: swap, action, skill, stat
  - Necrozma can assimilate other creatures, and bonding into a single Pokemon.
    As an Extended Action, Necrozma may bond with a willing or helpless Pokemon, removing them from play until they are released as another Extended Action. Necrozma's Movement and Jumping capabilities become the bonded Pokemon's, as does Power if the bond's is higher. Necrozma's Athletics, Acrobatics, Combat, Stealth, and Perception become
    the bonded Pokemon's, though they are increased by one rank, to a maximum of 6d6. Necrozma takes the bond's Primary Type (or Secondary Type if its Primary Type is Psychic) as its Secondary Type.
    While bonded, the GM will designate one move as the bonded species' Level-Up Movelist as i …

- 🔴 **Wielder** — `todo` · P3 · themes: swap, skill
  - Pokemon with the Wielder Capability gain a +2 bonus to Disarming and cannot have their natural weapons disarmed or removed by moves such as Thief, Covet, Switcheroo, and Trick. Small Pokemon with this capability may additionally wield man-made Small Melee weapons, gaining all normal benefits. Medium and higher size category Pokemon may wield Large Melee weapons. These weapons occupy the Pokemon's Held Item slot when Wielded. Pokemon Wielding Weapons can only ever get access to Adept Combat Rank Moves from Weapons, even if their Combat Skill would allow them to qualify for higher.

- 🔴 **Zygarde Cells** — `todo` · P3 · themes: swap, action, stat
  - Zygarde is composed of many cells, its strength determined by how many are gathered.
...
- 🔴 **Groundshaper** — `todo` · P3 · themes: weather, action
...
- 🔴 **Inflatable** — `todo` · P3 · themes: weather, damage, action
...
- 🔴 **Weathershape** — `todo` · P3 · themes: weather
...
- 🔴 **Egg Warmer** — `todo` · P3 · themes: action
...
- 🔴 **Gather Unown** — `todo` · P3 · themes: action, stat
...
- 🔴 **Leaf Crafter** — `todo` · P3 · themes: action
...
- 🔴 **As One** — `todo` · P3 · themes: position, interrupt, swap, action, capture
  - This Pokemon is an adept rider, and is capable of transferring some of the power of its mount to itself while also protecting those it rides.
    
    This Pokemon may Mount any willing, Mountable Pokemon (or other Pokemon that the GM deems suitable) as an Extended Action. While Mounted, the other Pokemon is unable to be commanded, targeted separately, or use any Moves or Abilities. It is treated as part of this Pokemon in all respects, including able to fit inside the same Pokeball and Fainting at the same time, and the rider may not be knocked off. While Mounting, this Pokemon may not Mount any further Pokemon until it dismounts.
    
    While Mounting a Pokemon, the user's Movement Capabilities and Natu …

- 🔴 **Keystone Warp** — `todo` · P3 · themes: position, action
...
- 🔴 **Shapeshifter** — `todo` · P3 · themes: position, swap, action, skill
...
- 🔴 **Dream Mist** — `todo` · P3 · themes: barrier, action, stat
...
- 🔴 **Dream Reader** — `todo` · P3 · themes: barrier, swap, status
  - Pokemon with the Dream Reader Capability may view the dreams of Sleeping Pokemon and Trainers. If the Pokemon or Trainer was put to Sleep with a Dream Mist item, they may also form a moving image of the dream from the Dream Mist in the target, allowing others to get a brief glance of the contents of the dream. Pokemon with this Capability cannot read the dreams of targets with the Mindlock Capability.

- 🔴 **Pack Mon** — `todo` · P3 · themes: social
  - A Pokemon with Pack Mon instinctively belong to a rigid pack structure, and are naturally inclined to the top of that structure. Wild Pokemon that are of this Pokemon's unevolved form or at least 10 levels lower than the user will instantly obey the user's commands; showing a Pokemon with Pack Mon to a group of Wilds will put them at a Fearful disposition. However, two Pack Mons of the same species and within 10 Levels of each other will fight for dominance of the group. If a Wild Pack Leader is ten levels higher than your Pokemon, it will expect your Pokemon to obey it, and may attack if it does not.

- 🔴 **Volatile Bomb** — `todo` · P3 · themes: social
  - The Pokemon never loses Loyalty from using Self-Destruct or Explosion.
...
- 🔴 **Weapon Bond** — `todo` · P3 · themes: status, action
  - As an Extended Action, Zacian and Zamazenta may use an Ancestral Sword (Zacian) or Ancestral Shield (Zamazenta) to become Crowned Sword or Crowned Shield Forme respectively.  
    ...
    This form lasts until the Pokemon is Fainted or voluntarily relinquishes it as an Extended Action.

- 🔴 **Letter Press** — `todo` · P3 · themes: capture, stat
...
- 🔴 **Shrinkable** — `todo` · P3 · themes: damage, action
...
- 🔴 **Soulless** — `todo` · P3 · themes: heal, swap, stat
  - Shedinja is a unique Pokemon. Its default Ability will always be Wonder Guard and Shedinja's Max Hit Points is always 1. You may not add to a Shedinja's Hit Point stat, and Shedinja may not have Temporary Hit Points. However, Shedinja can't die and never gains Injuries. Given an Extended Rest, Shedinja always recovers to 1 Hit Point regardless of natural healing rate and how many Hit Points it had previously.

- 🔴 **Marsupial** — `todo` · P3 · themes: interrupt, capture, stat, social
...
- 🔴 **Blender** — `todo` · P3 · themes: multiturn, damage, action
...
- 🔴 **Fortune** — `todo` · P3 · themes: stat, social
...
- 🔴 **Hazard Immunity** — `todo` · P3 · themes: typing
...
- 🟢 **Alluring** — `likely` · P3 · themes: swap, action · code: POKE_EDGE_DEFS:17635
  - Pokemon who are Alluring smell very pleasant. Once per day, they may act as if they were a Bait Item.

- 🟢 **Aura Pulse** — `likely` · P3 · themes: other · code: pokeEdgeCapGrants:17472, POKE_EDGE_DEFS:17633, isPusherEdgeName:31411, pusherEdgeListAll:31452
...
- 🟢 **Aura Reader** — `likely` · P3 · themes: barrier · code: PE_CAP_ALIAS:17380
...
- 🟢 **Chilled** — `likely` · P3 · themes: other · code: STATUS_DEFS:325, FEATURE_STATUS_IMMUNITY:735, STATUS_IMMUNE_ABILITIES:757, SNACK_DEFS:16591, RESTORATIVE_CURE_RULES:26336, openApplyRestorative:26429
  - Pokemon with the Chilled Capability are always cold.

- 🟢 **Darkvision** — `likely` · P3 · themes: status · code: EQUIP_EFFECTS:11707, FEATURE_CAPS:11778
...
- 🟢 **Dead Silent** — `likely` · P3 · themes: other · code: FEATURE_MODES:24303
...
- 🟢 **Firestarter** — `likely` · P3 · themes: damage · code: PE_RANGED_CAPS:17377, monCapabilities:19442
...
- 🟢 **Fountain** — `likely` · P3 · themes: damage · code: PE_RANGED_CAPS:17377
...
- 🟢 **Freezer** — `likely` · P3 · themes: damage · code: PE_RANGED_CAPS:17377
...
- 🟢 **Gilled** — `likely` · P3 · themes: other · code: FEATURE_CAPS:11777
...
- 🟢 **Guster** — `likely` · P3 · themes: damage · code: PE_RANGED_CAPS:17377
...
- 🟢 **Heater** — `likely` · P3 · themes: other · code: FEATURE_CAPS:11783
  - A Pokemon with the Heater Capability is always warm.

- 🟢 **Herb Growth** — `likely` · P3 · themes: action, stat · code: trainerCapGrants:11849
...
- 🟢 **Illusionist** — `likely` · P3 · themes: action, skill · code: FEATURE_CAPS:11781
...
- 🟢 **Invisibility** — `likely` · P3 · themes: damage, action · code: PE_CAP_ALIAS:17380, POKE_EDGE_DEFS:17638
...
- 🟢 **Living Weapon** — `likely` · P3 · themes: swap, status, damage, action, skill · code: LIVING_WEAPON_FORMS:7715, livingWeaponOf:7739, derivedMonMoves:19978, renderPokemonMoves:24098, renderTrainerCombat:33119
...
- 🟢 **Magnetic** — `likely` · P3 · themes: position · code: FEATURE_CAPS:11782
...
- 🟢 **Materializer** — `likely` · P3 · themes: damage · code: PE_RANGED_CAPS:17377
...
- 🟢 **Mindlock** — `likely` · P3 · themes: interrupt, typing · code: FEATURE_CAPS:11787
...
- 🟢 **Naturewalk** — `likely` · P3 · themes: weather · code: trainerHasCapability:11869, CAP_FIELD_LABEL:19322, capsSkillsCard:19504, encounterCapsRow:34781
...
- 🟢 **Phasing** — `likely` · P3 · themes: weather, heal, action · code: FEATURE_MODES:24307
...
- 🟢 **Planter** — `likely` · P3 · themes: other · code: gardenPlanterHolding:32117, gardenSoil:32142, openGardenPlant:32518, gardenPlantRow:32647
...
- 🟢 **Reach** — `likely` · P3 · themes: other · code: ITEM_MOVES:25349
...
- 🟢 **Sprouter** — `likely` · P3 · themes: action · code: resetUses:4860, trainerCapGrants:11849
...
- 🟢 **Stealth** — `likely` · P3 · themes: weather, swap, skill · code: EDGE_FX:139, CAPTURE_SKILLS:26244
...
- 🟢 **Telekinetic** — `likely` · P3 · themes: position, damage, skill · code: POKE_EDGE_DEFS:17648, ABILITY_CAP_GRANTS:19383
...
- 🟢 **Telepath** — `likely` · P3 · themes: typing, skill · code: PE_CAP_ALIAS:17380
...
- 🟢 **Threaded** — `likely` · P3 · themes: position, damage, action · code: FEATURE_CAPS:11779, POKE_EDGE_DEFS:17643, capCanonName:19338
...
- 🟢 **Tracker** — `likely` · P3 · themes: action, skill · code: POKE_EDGE_DEFS:17651
...
- 🟢 **Underdog** — `likely` · P3 · themes: stat · code: evolveTo:1624, isUnderdogMon:17405, pokeEdgeBaseBonus:17490, pokeEdgeBlocksEvolution:17491, underdogLessonSpecies:17517, POKE_EDGE_DEFS:17571, openUnderdogLessonMove:17776
...
- 🟢 **Wallclimber** — `likely` · P3 · themes: barrier, position · code: FEATURE_CAPS:11779
...
- 🟢 **X-Ray Vision** — `likely` · P3 · themes: other · code: EQUIP_EFFECTS:11708
...
- 🟢 **Zapper** — `likely` · P3 · themes: damage · code: PE_RANGED_CAPS:17377
...
- ⚪ **Amorphous** — `manual` · P3 · themes: other
  - Pokemon that are Amorphous have an inconsistent shape. They can flatten and reform themselves like putty. They can stretch out their body material and condense themselves as well. They're able to squeeze through tight spaces, such as under a door.

- ⚪ **Augments** — `manual` · P3 · themes: other

- ⚪ **Datajack** — `manual` · P3 · themes: other
  - n/a

- ⚪ **Delta Evolution** — `manual` · P3 · themes: other
  - Rayquaza may Mega-Evolve without holding a Mega Stone as long as it knows the Move Dragon Ascent.

- ⚪ **Dermal Plating** — `manual` · P3 · themes: other
  - Dermal

- ⚪ **Embedded Weaponry** — `manual` · P3 · themes: other
  - Limbs

- ⚪ **Enhanced Sight** — `manual` · P3 · themes: other
  - Eyes

- ⚪ **Glow** — `manual` · P3 · themes: other
  - A Pokemon with the Glow Capability can emit light from a part of its body. Depending on the variety of wild Pokemon nearby, it might attract Pokemon or ward them away.

- ⚪ **Hazard Tolerance** — `manual` · P3 · themes: other
  - Lowers the toxicity of all environments by one step. High toxicity becomes medium, medium becomes low, and low toxicity is ignored altogether.

- ⚪ **Medical Nanobots** — `manual` · P3 · themes: other
  - Body

- ⚪ **Mountable X** — `manual` · P3 · themes: other
  - This Pokemon may serve as a mount for X average Trainers regardless of Power Capability and ignoring penalties for weight carried. This Capability fails to function if significant weight is added in addition to the Trainer(s). Note that this Capability is meant to be used as a guideline, not a hard and fast rule. Feel free to adjust which Pokemon can be ridden as fits your campaign.

- ⚪ **Premonition** — `manual` · P3 · themes: other
  - Pokemon with this Capability have a supernatural sense for natural disasters such as earthquakes, floods, and volcanic eruptions. The magnitude of the impending disaster and its proximity to the Pokemon both affect how often they get this sense before a disaster and how long in advance the warning is. Closer and bigger disasters tend to have a greater effect and may alert the Pokemon to the specific area where a disaster will occur days in advance, while lesser disasters may simply give the Pokemon an odd sense of unease several hours before they hit.
...
- ⚪ **Thermal-Optical Camouflage** — `manual` · P3 · themes: other
  - Dermal

- ⚪ **Upgraded Dermal Plating** — `manual` · P3 · themes: other
  - Dermal

- ⚪ **Upgraded Embedded Weaponry** — `manual` · P3 · themes: other
  - Limbs

- ⚪ **Upgraded Enhanced Sight** — `manual` · P3 · themes: other
  - Eyes

- ⚪ **Upgraded Medical Nanobots** — `manual` · P3 · themes: other
  - Body

- ⚪ **Upgraded Smart Vision** — `manual` · P3 · themes: other
  - Eyes

- ⚪ **Upgraded Synthetic Muscle** — `manual` · P3 · themes: other
  - Limbs

- ⚪ **Upgraded Thermal-Optical Camouflage** — `manual` · P3 · themes: other
  - Dermal

- ⚪ **Upgraded Wired Reflexes** — `manual` · P3 · themes: other
  - Body

- ⚪ **Vacuum Immunity** — `manual` · P3 · themes: other
  - Prevents all injuries from vacuum exposure.

- ⚪ **Vacuum Tolerance** — `manual` · P3 · themes: other
  - Slows down the rate of injury gain, causing the Pokemon with the capability to gain injuries from vacuum exposure once every 5 minutes instead of one every round.

- ⚪ **Wired** — `manual` · P3 · themes: other
  - Wired Pokemon have a special relation to electronic devices. They can enter machines and travel through connected electronics through any cords that connect them instantly. If used by a Rotom, Rotom may take control of the machine from within, gaining a Move chosen by your GM based on the machine.

- ⚪ **Wired Reflexes** — `manual` · P3 · themes: other
  - Body
