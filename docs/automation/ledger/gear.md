...
- 🔴 **King's Rock** — `todo` · P1 (player:Lázaro) · themes: swap, status
  - _Pokémon Item · $$2500_
...
- 🔴 **Lax Incense** — `todo` · P1 (player:Lysgd) · themes: stat
  - _Pokémon Item · $$2000_
...
- 🔴 **Ability Shield** — `todo` · P3 · themes: swap
  - _Pokémon Item · $$1500_
...
- 🔴 **Booster Energy** — `todo` · P3 · themes: weather, position, swap, status, action
  - _Pokémon Item · $$7500_
...
- 🔴 **Bug Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Clear Amulet** — `todo` · P3 · themes: swap, cs, skill
  - _Pokémon Item · $$2500_
...
- 🔴 **Covert Cloak** — `todo` · P3 · themes: heal, interrupt, swap, typing, damage, action, skill
  - _Pokémon Item · $$5000_
...
- 🔴 **Dark Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Dragon Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Electric Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Aspear Berry** — `todo` · P1 (player:Lysgd) · themes: status, cure
  - _Food · $$150_
  - Cures Freeze, Tough Poffin Ingredient. Tier 1

- 🔴 **Dry Wafer** — `todo` · P1 (player:Lázaro) · themes: status, damage
  - _Food · $$100_
...
- 🔴 **Leppa Berry** — `todo` · P1 (player:Lysgd) · themes: heal
  - _Food · $$500_
  - Restores a Scene Move. Tier 3.

- 🔴 **Pecha Berry** — `todo` · P1 (player:Lázaro) · themes: status, cure
  - _Food · $$150_
  - Cures Poison, Cute Poffin Ingredient. Tier 1.

- 🔴 **Pomeg Berry** — `todo` · P1 (player:Lázaro) · themes: stat
  - _Food · $$500_
  - Lowers HP stat by 1 with trainer permission. Tier 3.

- 🔴 **Super Soda Pop** — `todo` · P1 (player:Lysgd) · themes: heal
  - _Food · $$125_
  - Heals 30 Hit Points

- 🔴 **Sweet Confection** — `todo` · P1 (player:Lázaro) · themes: multiturn, status, damage
  - _Food · $$100_
...
- 🔴 **Apicot Berry** — `todo` · P3 · themes: cs
  - _Food · $$250_
  - +1 Special Defense CS. Tier 2.

- 🔴 **Babiri Berry** — `todo` · P3 · themes: typing
  - _Food · $$500_
  - Weakens foe’s super effective Steel-type move. Tier 3.

- 🔴 **Baby Food** — `todo` · P3 · themes: swap, stat
  - _Food · $--_
...
- 🔴 **Bitter Treat** — `todo` · P3 · themes: interrupt, status, damage
  - _Food · $$100_
...
- 🔴 **Black Sludge** — `todo` · P3 · themes: heal, swap, status
  - _Food · $$500_
...
- 🔴 **Bounce Case** — `todo` · P3 · themes: interrupt, capture
...
- 🔴 **Camera Kit** — `todo` · P3 · themes: skill, capture
...
- 🔴 **Contest Case** — `todo` · P3 · themes: social
...
- 🔴 **Devil Case** — `todo` · P3 · themes: heal, status, capture
...
- 🔴 **Fabulous Ball** — `todo` · P3 · themes: damage, stat, social
...
- 🔴 **Medicine Case** — `todo` · P3 · themes: position, heal, swap, status, action, capture
  - _Poké Ball · Slot -- · $$400_
...
- 🔴 **Mold Ball** — `todo` · P3 · themes: status
  - _Poké Ball · Slot +0 · $--_
  - -20 Modifier if the target is Poison or Fighting type.

- 🔴 **Nest Ball** — `todo` · P3 · themes: stat
  - _Poké Ball · Slot +0 · $$800_
  - -20 Modifier if the target is under level 10.

- 🔴 **Poké Ball Tracking Chip** — `todo` · P3 · themes: capture
...
- 🔴 **Storage Case** — `todo` · P3 · themes: capture
...
- 🔴 **Sun Ball** — `todo` · P3 · themes: weather
  - _Poké Ball · Slot +0 · $--_
  - -20 Modifier if the weather is sunny when used.

- 🔴 **Ultra Ball** — `todo` · P3 · themes: capture
  - _Poké Ball · Slot -15.0 · $$800_
  - The best generic Poké Ball.

- 🔴 **Zap Case** — `todo` · P3 · themes: damage, skill, capture
...
P1 · 17 open of 17 · open

- 🔴 **Basic Rope** — `todo` · P1 (player:Lázaro) · themes: heal, damage
  - _Key Item · $$100_
...
- 🔴 **First Aid Kit** — `todo` · P1 (player:Lázaro) · themes: heal, status, cure, action, skill
  - _Key Item · $$500_
...
- 🔴 **Poké Ball Technical Manual [5-15 Playtest]** — `todo` · P1 (player:Lázaro) · themes: damage, skill
  - _Key Item · $$1000_
...
- 🔴 **Sturdy Rope** — `todo` · P1 (player:Lázaro) · themes: heal, damage
  - _Key Item · $$400_
  - Sturdy Rope with a tensile strength of 225 kg or roughly 500lbs. 30 Hit Points and 20 Damage Reduction.
    
    Rope can only be damaged by Fire-Type attacks, attacks made with sharp objects(knives, swords, sharp teeth), and moves like Scratch, Slash, Leaf Blade, Razor Leaf, etc. The Move Cut ignores all Damage Reduction against Rope. Rope can be bought in any length of 25 ft up to 300.

- 🔴 **Tinfoil Gospel: Your Primer on Thwarting the Conspiracies of the New World Order [5-15 Playtest]** — `todo` · P1 (player:Lázaro) · themes: typing, skill
  - _Key Item · $$1000_
...
- 🔴 **Type Study Manual [5-15 Playtest]** — `todo` · P1 (player:Lysgd) · themes: skill, capture, stat
  - _Key Item · $$1000_
...
- 🔴 **A Field Guide to Fungi [5-15 Playtest]** — `todo` · P3 · themes: heal, swap, status, cs, action, skill
  - _Key Item · $$1000_
...
- 🔴 **Bait** — `todo` · P3 · themes: action, skill
  - _Key Item · $$250_
...
- 🔴 **Combat Medic's Primer [9-15 Playtest]** — `todo` · P3 · themes: heal, interrupt, swap, status, action, skill
  - _Key Item · $$1000_
...
- 🔴 **Dowsing for Dummies [5-15 Playtest]** — `todo` · P3 · themes: skill
  - _Key Item · $$1000_
...
- 🔴 **First Aid Manual [5-15 Playtest]** — `todo` · P3 · themes: action, skill
  - _Key Item · $$1000_
...
- 🔴 **How Berries?? [5-15 Playtest]** — `todo` · P3 · themes: action, skill
  - _Key Item · $$1000_
...
- 🔴 **Saddle** — `todo` · P3 · themes: interrupt, skill
  - _Key Item · $$2000_
...
- 🔴 **Super Bait** — `todo` · P3 · themes: action, skill
  - _Key Item · $$200_
...
- 🔴 **Travel Guide [5-15 Playtest]** — `todo` · P3 · themes: weather, damage, skill
  - _Key Item · $$1000_
...
- 🔴 **Antidote** — `todo` · P1 (player:Handels, player:Lázaro) · themes: status, cure
  - _Med Kit · $$200_
  - Cures Poison

- 🔴 **Burn Heal** — `todo` · P1 (player:Handels) · themes: status, cure
  - _Med Kit · $$200_
  - Cures Burns

- 🔴 **Paralyze Heal** — `todo` · P1 (player:Handels, player:Lázaro) · themes: cure
  - _Med Kit · $$200_
  - Cures Paralysis

- 🔴 **Revival Herb** — `todo` · P1 (player:Lázaro) · themes: heal
  - _Med Kit · $$350_
  - Revives Pokémon and sets to 50% Hit Points - Repulsive

- 🔴 **Anti-Radiation Pills** — `todo` · P3 · themes: hazard, interrupt, status, typing
  - _Med Kit · $$400_
...
- 🔴 **Berserker Bolus** — `todo` · P3 · themes: status, typing, damage, skill
  - _Med Kit · $$500_
...
- 🔴 **Heal Powder** — `todo` · P3 · themes: cure
  - _Med Kit · $$350_
  - Cure all Persistent Status Afflictions – Repulsive

- 🔴 **Ice Heal** — `todo` · P3 · themes: status, cure
  - _Med Kit · $$200_
  - Cures Freezing

- 🔴 **Locus Lozenge** — `todo` · P3 · themes: skill
  - _Med Kit · $$500_
...
- 🔴 **Prescient Powder** — `todo` · P3 · themes: heal
  - _Med Kit · $$2500_
...
- 🔴 **Puissance Pellet** — `todo` · P3 · themes: heal, multiturn, cs, skill
  - _Med Kit · $$450_
...
- 🔴 **Rambo Roids** — `todo` · P3 · themes: skill
  - _Med Kit · $$750_
...
- 🔴 **Shock Syringe** — `todo` · P3 · themes: status, damage, skill
  - _Med Kit · $$500_
...
- 🔴 **Soldier Pill** — `todo` · P3 · themes: status
  - _Med Kit · $$750_
...
- 🔴 **Spritz Spray** — `todo` · P3 · themes: damage, skill
  - _Med Kit · $$250_
...
- 🔴 **Stat Suppressants** — `todo` · P3 · themes: stat
  - _Med Kit · $$500_
...
- 🔴 **White Light** — `todo` · P3 · themes: skill
  - _Med Kit · $$800_
...
P3 · 30 open of 30 · open

- 🔴 **Expert Belt** — `todo` · P3 · themes: swap, typing, damage
  - _Pokémon Item · $$3500_
...
- 🔴 **Fairy Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Fighting Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Ghost Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Grass Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Ground Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Ice Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Iron Ball** — `todo` · P3 · themes: swap, typing, action
  - _Pokémon Item · $$900_
...
- 🔴 **Luck Incense** — `todo` · P3 · themes: damage
  - _Pokémon Item · $$1800_
...
- 🔴 **Metal Powder** — `todo` · P3 · themes: cs, skill
  - _Pokémon Item · $--_
...
- 🔴 **Normal Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Poison Brace** — `todo` · P3 · themes: swap, status, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Poison Gem** — `todo` · P3 · themes: swap, status, damage, action
  - _Pokémon Item · $--_
...
- 🔴 **Psychic Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Punching Glove** — `todo` · P3 · themes: interrupt, swap, damage
  - _Pokémon Item · $$4000_
...
- 🔴 **Stat Boosters** — `todo` · P3 · themes: swap, cs, damage, skill, stat
  - _Pokémon Item · $$4000_
...
- 🔴 **Steel Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Toxic Orb** — `todo` · P3 · themes: swap, status, action
  - _Pokémon Item · $$4800_
  - Induces Poison on holder. Off-Hand Item for Trainers. Standard Action to drop.

- 🔴 **Type Boosters** — `todo` · P3 · themes: swap, status, damage, skill
  - _Pokémon Item · $$1800_
...
- 🔴 **Type Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Type Plates** — `todo` · P3 · themes: swap
  - _Pokémon Item · $--_
...
- 🔴 **Water Brace** — `todo` · P3 · themes: swap, damage
  - _Pokémon Item · $$2000_
...
- 🔴 **Shuca Berry** — `todo` · P3 · themes: typing
  - _Food · $$500_
  - Weakens foe’s super effective Ground-type move. Tier 3.

- 🔴 **Shuckle's Berry Juice** — `todo` · P3 · themes: heal
  - _Food · $--_
  - Heals 30 Hit Points

- 🔴 **Sour Candy** — `todo` · P3 · themes: interrupt, status, damage
  - _Food · $$100_
...
- 🔴 **Sparkling Lemonade** — `todo` · P3 · themes: heal
  - _Food · $$250_
  - Heals 50 Hit Points

- 🔴 **Spicy Wrap** — `todo` · P3 · themes: status, damage
  - _Food · $$100_
...
P3 · 31 open of 31 · open

- 🔴 **Bean Cap [5-15 Playtest]** — `todo` · P3 · themes: heal, status, damage, skill
...
- 🔴 **Capture Styler** — `todo` · P3 · themes: skill, capture, social
...
- 🔴 **Cleanse Tag** — `todo` · P3 · themes: control, status, damage, action, skill
  - _Equipment · Slot Consumable · $$500_
...
- 🔴 **Dream Mist** — `todo` · P3 · themes: barrier, status, damage, action
  - _Equipment · Slot Consumable · $$500_
...
- 🔴 **EMP Grenade** — `todo` · P3 · themes: control, status, damage, skill, capture
...
- 🔴 **Flashbang** — `todo` · P3 · themes: control, status, damage, skill, capture
...
- 🔴 **Glue Cannon Charge Packet** — `todo` · P3 · themes: multiturn
  - _Equipment · Slot Consumable · $$100_
  - A charge packet for Glue Cannons.

- 🔴 **Glue Cap [5-15 Playtest]** — `todo` · P3 · themes: status, damage, skill
  - _Equipment · Slot Consumable · $$100_
...
- 🔴 **Hazmat Suit** — `todo` · P3 · themes: hazard, status, typing
...
- 🔴 **Inferno Cannon** — `todo` · P3 · themes: control
  - _Equipment · Slot Hands · $$1000_
  - Uses the Move Inferno once.

- 🔴 **Magic Flute** — `todo` · P3 · themes: cure, action
...
- 🔴 **Net Cap [5-15 Playtest]** — `todo` · P3 · themes: status, damage, action, skill, capture
...
- 🔴 **Pester Ball: Burn** — `todo` · P3 · themes: status, typing
...
- 🔴 **Pester Ball: Confusion** — `todo` · P3 · themes: status, typing
  - _Equipment · Slot Consumable · $$350_
...
- 🔴 **Pester Ball: Paralysis** — `todo` · P3 · themes: typing
  - _Equipment · Slot Consumable · $$350_
...
- 🔴 **Pester Ball: Poison** — `todo` · P3 · themes: status, typing
  - _Equipment · Slot Consumable · $$350_
...
- 🔴 **Pester Ball: Rage** — `todo` · P3 · themes: typing
  - _Equipment · Slot Consumable · $$350_
...
- 🔴 **Pester Ball: Sleep** — `todo` · P3 · themes: status, typing
  - _Equipment · Slot Consumable · $$350_
...
- 🔴 **Pester Balls** — `todo` · P3 · themes: interrupt, status, typing
  - _Equipment · Slot Consumable · $$350_
...
- 🔴 **Poké Ball Cannon** — `todo` · P3 · themes: damage, action, capture
...
- 🔴 **Scrubbing Spray** — `todo` · P3 · themes: skill
...
- 🔴 **Snag Machine** — `todo` · P3 · themes: swap, action, capture
...
- 🔴 **Sonic Filter** — `todo` · P3 · themes: damage
...
- 🔴 **Spacesuit** — `todo` · P3 · themes: hazard, typing
...
- 🔴 **Sting Grenade** — `todo` · P3 · themes: multiturn, damage, capture
  - _Equipment · Slot Consumable · $$250_
...
- 🔴 **Toxic Caltrops** — `todo` · P3 · themes: hazard, control, swap, action
  - _Equipment · Slot Consumable · $$500_
  - Lets the user use the move Toxic Spikes as a Standard Action.  The item is then consumed.

- 🔴 **Weighted Nets** — `todo` · P3 · themes: position, heal, status, damage, action, capture
...
- 🔴 **Wonder Launcher** — `todo` · P3 · themes: heal, swap, action, skill, stat
...
- 🔴 **Zap Blaster** — `todo` · P3 · themes: control
  - _Equipment · Slot Hands · $$1000_
...
- ⚪ **Air Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $--_
...
- ⚪ **Dive Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $$800_
...
- ⚪ **Dusk Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $$800_
...
- ⚪ **Earth Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $--_
...
- ⚪ **Gossamer Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $--_
...
- ⚪ **Haunt Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $--_
...
- ⚪ **Heat Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $--_
  - -20 Modifier if the target is Electric or Fire type.

- ⚪ **Heavy Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $$800_
...
- ⚪ **Love Ball** — `manual` · P1 (player:Lázaro) · themes: other
  - _Poké Ball · Slot +0 · $$800_
...
- ⚪ **Lure Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $$800_
...
- ⚪ **Master Ball** — `manual` · P3 · themes: other
...
- ⚪ **Moon Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $$800_
...
- ⚪ **Mystic Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $--_
...
- ⚪ **Net Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $$800_
...
- ⚪ **Quick Ball** — `manual` · P1 (player:Lázaro) · themes: other
...
- ⚪ **Repeat Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $$800_
...
- ⚪ **Solid Ball** — `manual` · P3 · themes: other
  - _Poké Ball · Slot +0 · $--_
...
- ⚪ **Timer Ball** — `manual` · P1 (player:Lysgd) · themes: other
