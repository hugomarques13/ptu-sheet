...
- 🔴 **Roseli Berry** — `todo` · P3 · themes: typing
...
P9 · 48 open of 48 · open

- 🟢 **Aspear Berry** — `likely` · P1 (player:Lysgd) · themes: status, cure · code: SNACK_DEFS:16414
  - Cures freeze

- 🟢 **Dry Wafer** — `likely` · P1 (player:Lázaro) · themes: status, damage · code: SNACK_DEFS:16406
...
- 🟢 **Leftovers** — `likely` · P1 (player:Lysgd, player:Lázaro) · themes: heal · code: SNACK_DEFS:16400, eatSnack:16653, chefDumplingIngredients:29079
  - Recover 1/16th of max Hit Points at the beginning of each turn for the rest of the encounter

- 🟢 **Leppa Berry** — `likely` · P1 (player:Lysgd) · themes: heal · code: SNACK_DEFS:16441
  - Restores a Scene Move

- 🟢 **Pecha Berry** — `likely` · P1 (player:Lázaro) · themes: status, cure · code: SNACK_DEFS:16412
  - Cures poison

- 🟢 **Sweet Confection** — `likely` · P1 (player:Lázaro) · themes: multiturn, status, damage · code: SNACK_DEFS:16408
...
- 🟢 **Aguav Berry** — `likely` · P3 · themes: heal, status · code: SNACK_DEFS:16423
...
- 🟢 **Apicot Berry** — `likely` · P3 · themes: cs · code: SNACK_DEFS:16429
  - Special Defense CS +1

- 🟢 **Bitter Treat** — `likely` · P3 · themes: status, damage · code: SNACK_DEFS:16407
...
- 🟢 **Black Sludge** — `likely` · P3 · themes: heal · code: SNACK_DEFS:16401
  - Recover 1/8th of max Hit Points at the beginning of each turn for the rest of the encounter

- 🟢 **Candy Bar** — `likely` · P3 · themes: heal · code: SNACK_DEFS:16398
  - Restores 5 Hit Points

- 🟢 **Cheri Berry** — `likely` · P3 · themes: cure · code: SNACK_DEFS:16410
  - Cures paralysis

- 🟢 **Chesto Berry** — `likely` · P3 · themes: status, cure · code: SNACK_DEFS:16411
  - Cures sleep

- 🟢 **Chilan Berry** — `likely` · P3 · themes: other · code: SNACK_DEFS:16453
  - Weakens foe's Normal-type move by one step

- 🟢 **Cornn Berry** — `likely` · P3 · themes: control, status, cure · code: SNACK_DEFS:16436
  - Cures Disabled condition

- 🟢 **Custap Berry** — `likely` · P3 · themes: interrupt · code: SNACK_DEFS:16442
  - Grants the Priority keyword to any Move. May only be used at 25% HP or lower.

- 🟢 **Enigma Berry** — `likely` · P3 · themes: interrupt, typing · code: SNACK_DEFS:16432
  - User gains Temporary HP equal to 1/6th of their Max HP when hit by a Super Effective Move.

- 🟢 **Figy Berry** — `likely` · P3 · themes: heal, status · code: SNACK_DEFS:16420
...
- 🟢 **Ganlon Berry** — `likely` · P3 · themes: cs · code: SNACK_DEFS:16426
  - Defense CS +1

- 🟢 **Herbal Restorative** — `likely` · P3 · themes: skill · code: SNACK_DEFS:16475, openApplyRestorative:25817, isHerbalRestorative:25828, herbalConsume:25852
  - [Playtest] +2 bonus on a Save Check.

- 🟢 **Honey** — `likely` · P3 · themes: heal · code: SNACK_DEFS:16399, eatSnack:16645
  - Restores 5 Hit Points

- 🟢 **Iapapa Berry** — `likely` · P3 · themes: heal, status · code: SNACK_DEFS:16424
...
- 🟢 **Jaboca Berry** — `likely` · P3 · themes: damage · code: SNACK_DEFS:16434
  - Foe dealing Physical Damage to the user loses 1/8 of their Maximum HP.

- 🟢 **Kee Berry** — `likely` · P3 · themes: interrupt, cs, action · code: SNACK_DEFS:16443
  - Defense CS +1. Activates as a Free Action when hit by a Physical Move.

- 🟢 **Lansat Berry** — `likely` · P3 · themes: damage · code: SNACK_DEFS:16430
  - Increases Critical Range by +1 for the remainder of the encounter.

- 🟢 **Liechi Berry** — `likely` · P3 · themes: cs · code: SNACK_DEFS:16425
  - Attack CS +1

- 🟢 **Lum Berry** — `likely` · P3 · themes: cure · code: SNACK_DEFS:16418, snackByKey:16484
  - Cures any single status ailment

- 🟢 **Mago Berry** — `likely` · P3 · themes: heal, status · code: SNACK_DEFS:16422
...
- 🟢 **Magost Berry** — `likely` · P3 · themes: status, cure · code: SNACK_DEFS:16437
  - Cures Enraged condition

- 🟢 **Maranga Berry** — `likely` · P3 · themes: interrupt, cs, action · code: SNACK_DEFS:16444
  - Special Defense CS +1. Activates as a Free Action when hit by a Special Move.

- 🟢 **Mental Herb** — `likely` · P3 · themes: cure · code: SNACK_DEFS:16465
  - Cures all Volatile Status Effects

- 🟢 **Micle Berry** — `likely` · P3 · themes: damage · code: SNACK_DEFS:16433
  - Increases Accuracy by +1.

- 🟢 **Nomel Berry** — `likely` · P3 · themes: status, cure · code: SNACK_DEFS:16439
  - Cures Infatuated condition

- 🟢 **Oran Berry** — `likely` · P3 · themes: heal · code: SNACK_DEFS:16415, gardenGrowers:31298
  - Restores 5 Hit Points

- 🟢 **Persim Berry** — `likely` · P3 · themes: status, cure · code: SNACK_DEFS:16416
  - Cures Confusion

- 🟢 **Petaya Berry** — `likely` · P3 · themes: cs · code: SNACK_DEFS:16428
  - Special Attack CS +1

- 🟢 **Power Herb** — `likely` · P3 · themes: multiturn · code: SNACK_DEFS:16467
  - Eliminates the Set-Up turn of Moves with the Set-Up Keyword

- 🟢 **Rabuta Berry** — `likely` · P3 · themes: status, cure · code: SNACK_DEFS:16438
  - Cures Suppressed condition

- 🟢 **Rawst Berry** — `likely` · P3 · themes: status, cure · code: SNACK_DEFS:16413
  - Cures burn

- 🟢 **Rowap Berry** — `likely` · P3 · themes: damage · code: SNACK_DEFS:16435
  - Foe dealing Special Damage to the user loses 1/8 of their Maximum HP.

- 🟢 **Salac Berry** — `likely` · P3 · themes: cs · code: SNACK_DEFS:16427
  - Speed CS +1

- 🟢 **Salty Surprise** — `likely` · P3 · themes: heal, interrupt, status · code: SNACK_DEFS:16403
...
- 🟢 **Sitrus Berry** — `likely` · P3 · themes: heal · code: inventoryRow:12565, SNACK_DEFS:16419, snackByKey:16484, openFoodPicker:16968
  - Restores 15 Hit Points

- 🟢 **Sour Candy** — `likely` · P3 · themes: status, damage · code: SNACK_DEFS:16405
...
- 🟢 **Spicy Wrap** — `likely` · P3 · themes: status, damage · code: SNACK_DEFS:16404
...
- 🟢 **Starf Berry** — `likely` · P3 · themes: cs, stat · code: SNACK_DEFS:16431
  - Random stat CS +2.  May be used only at 25% HP or lower.

- 🟢 **White Herb** — `likely` · P3 · themes: cs, skill · code: SNACK_DEFS:16466
  - Any negative Combat Stages are set to 0

- 🟢 **Wiki Berry** — `likely` · P3 · themes: heal, status · code: SNACK_DEFS:16421
