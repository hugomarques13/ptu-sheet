...
- 🔴 **Skill Enhancement** — `todo` · P2 (enc) · themes: skill
  - _Skill Edges_
...
- 🔴 **Train the Reserves** — `todo` · P2 (enc) · themes: skill, stat
...
- 🔴 **Beast Master** — `todo` · P3 · themes: skill, stat, social
...
- 🔴 **Groomer** — `todo` · P3 · themes: skill, stat, social
  - _Pokémon Training Edges · Prereq: Novice Pokemon Education_
...
- 🔴 **Paleontologist** — `todo` · P3 · themes: skill
...
- 🔴 **PokePsychologist** — `todo` · P3 · themes: skill, social
...
- 🔴 **Pokebot Training** — `todo` · P3 · themes: skill
...
- 🔴 **PokéPsychologist** — `todo` · P3 · themes: skill, social
  - _Other Edges · Prereq: Novice Pokemon Education_
  - You may use your Pokemon Education Skill instead of Charm, Guile, Intimidate, or Intuition when making general Skill checks to interact with Pokemon or to raise or lower disposition.

- 🔴 **Pokébot Training** — `todo` · P3 · themes: skill
  - _Do Porygon Dream of Mareep · Prereq: Novice Technology Education_
  - You may control a Pokebot with Complexity up to your Technology Rank by using a Pokemon turn.

- 🔴 **Tag Scribe** — `todo` · P3 · themes: skill
...
- 🔴 **Elemental Connection** — `todo` · P1 (enc, player:Lysgd, player:Lázaro) · themes: typing, skill
  - _Other Edges_
...
- 🔴 **Gem Lore** — `todo` · P3 · themes: action
  - _Crafting Edges · Prereq: Novice Occult Education_
...
- 🔴 **Quick Case** — `todo` · P3 · themes: action, capture
  - _Do Porygon Dream of Mareep · Prereq: Novice Technology Education_
...
- 🔴 **Emergency Repairs** — `todo` · P3 · themes: heal, damage, action, skill
  - _Do Porygon Dream of Mareep · Prereq: Novice Technology Education_
...
- 🔴 **Field Clinic [9-15 Playtest]** — `todo` · P3 · themes: heal, action
...
- 🔴 **Slippery** — `todo` · P3 · themes: position, swap, skill
...
- 🔴 **Traveler** — `todo` · P3 · themes: position, skill
...
- 🔴 **Grace** — `todo` · P3 · themes: swap, damage, stat, social
...
- 🔴 **Trainer of Champions** — `todo` · P3 · themes: stat
...
- 🟢 **Basic Balls** — `likely` · P1 (player:Lázaro) · themes: capture · code: POKEBALL_RECIPES:30879
...
- 🟢 **Basic Cooking** — `likely` · P1 (player:Handels) · themes: other · code: CHEF_RECIPES:29126
...
- 🟢 **Charmer** — `likely` · P1 (enc, player:Handels, player:Lysgd) · themes: other · code: EDGE_FX:119
  - _Combat Edges · Prereq: Novice Charm_
  - You learn the move Baby-Doll Eyes.

- 🟢 **Demoralize** — `likely` · P1 (enc, player:Lysgd) · themes: status, damage · code: openTrainerAttack:9470, FEATURE_GIFTS:11040
...
- 🟢 **Flustering Charisma** — `likely` · P1 (player:Lysgd) · themes: interrupt · code: EDGE_FX:131
...
- 🟢 **Intimidating Presence** — `likely` · P1 (enc, player:Handels) · themes: other · code: EDGE_FX:121
  - _Combat Edges · Prereq: Novice Intimidate_
  - You learn the move Leer.

- 🟢 **Master Skills** — `likely` · P1 (enc, player:Handels, player:Lysgd, player:Lázaro) · themes: skill · code: VIRTUOSO_EDGE:36
  - _Skill Edges · Prereq: Level 12_
  - You Rank Up a Skill from Expert to Master. You may take this Edge multiple times.

- 🟢 **Medic Training** — `likely` · P1 (enc, player:Lysgd, player:Lázaro) · themes: heal, multiturn · code: EDGE_FX:143, FEATURE_GIFTS:11043, openApplyRestorative:25722
...
- 🟢 **Smooth** — `likely` · P1 (enc, player:Lysgd) · themes: status, damage · code: EDGE_FX:129
...
- 🟢 **Acrobat** — `likely` · P2 (enc) · themes: position · code: EDGE_FX:136
  - _Other Edges · Prereq: Novice Acrobatics_
  - Increase your Jump and Long Jump Capabilities by +1 each.

- 🟢 **Athletic Initiative** — `likely` · P2 (enc) · themes: other · code: EDGE_FX:116
  - _Combat Edges · Prereq: Adept Athletics_
  - You learn the move Agility.

- 🟢 **Bad Mood** — `likely` · P2 (enc) · themes: damage · code: badMoodCrit:7836
...
- 🟢 **Basic Martial Arts** — `likely` · P2 (enc) · themes: other · code: EDGE_FX:117
  - _Combat Edges · Prereq: Novice Combat_
  - You learn the move Rock Smash.

- 🟢 **Basic Psionics** — `likely` · P2 (enc) · themes: status · code: EDGE_FX:118
  - _Combat Edges · Prereq: Elemental Connection (Psychic)_
  - You learn the move Confusion.

- 🟢 **Categoric Inclination** — `likely` · P2 (enc) · themes: skill · code: categoricBonus:89, renderTrainer:7083
  - _Skill Edges_
  - Choose Body, Mind, or Spirit. You gain a +1 Bonus to all Skill Checks of that Category.

- 🟢 **Confidence Artist** — `likely` · P2 (enc) · themes: other · code: EDGE_FX:120
  - _Combat Edges · Prereq: Novice Guile_
  - You learn the move Confide.

- 🟢 **Expert Manipulator** — `likely` · P2 (enc) · themes: action · code: EDGE_FX:132
...
- 🟢 **Expert Trickster** — `likely` · P2 (enc) · themes: action · code: EDGE_FX:133
...
- 🟢 **Swimmer** — `likely` · P2 (enc) · themes: position, skill · code: EDGE_FX:138
...
- 🟢 **Virtuoso** — `likely` · P2 (enc, player:Hugo) · themes: skill · code: rankAllowed:46, renderTrainer:7099, skillDiceHTML:10005, prereqStatus:10277
...
- 🟢 **Wallrunner** — `likely` · P2 (enc) · themes: skill · code: EDGE_FX:145
...
- 🟢 **Weapon of Choice** — `likely` · P2 (enc) · themes: typing, action · code: EDGE_FX:134
...
- 🟢 **Work Up** — `likely` · P2 (enc) · themes: other · code: EDGE_FX:125
  - _Combat Edges · Prereq: Adept Focus_
  - You learn the move Work Up.

- 🟢 **Apricorn Balls** — `likely` · P3 · themes: action, capture · code: POKEBALL_RECIPES:30872, pokeBallBenchCard:30912
...
- 🟢 **Art of Stealth** — `likely` · P3 · themes: swap, skill · code: EDGE_FX:139
  - _Other Edges · Prereq: Expert Stealth_
  - You gain the Stealth Capability.

- 🟢 **Defensive Hacking** — `likely` · P3 · themes: damage, skill · code: EDGE_FX:150
...
- 🟢 **Dynamism** — `likely` · P3 · themes: skill · code: categoricBonus:103, EDGE_FX:126
  - _Combat Edges · Prereq: Novice Guile_
  - Your initiative is increased by your Guile Rank.

- 🟢 **Field Clinic** — `likely` · P3 · themes: heal, action · code: FEATURE_GIFTS:11043, openApplyRestorative:25660
...
- 🟢 **Glitched Existence** — `likely` · P3 · themes: skill · code: EDGE_FX:151
...
- 🟢 **Gravity Training** — `likely` · P3 · themes: other · code: EDGE_FX:148
...
- 🟢 **Green Thumb** — `likely` · P3 · themes: other · code: GARDEN_TIERS:31221, gardenCanGrow:31268, openGardenPlant:31734, gardenCanSee:31774
...
- 🟢 **Instinctive Aptitude** — `likely` · P3 · themes: damage, action, skill · code: EDGE_FX:141, trainerVitalsCard:9880
...
- 🟢 **Instruction** — `likely` · P3 · themes: skill · code: EDGE_FX:142
...
- 🟢 **Mounted Prowess** — `likely` · P3 · themes: skill · code: EDGE_FX:144
...
- 🟢 **Poke Ball Repair** — `likely` · P3 · themes: skill, capture · code: pokeBallBenchCard:30918
...
- 🟢 **Poké Ball Repair** — `likely` · P3 · themes: skill, capture · code: pokeBallBenchCard:30918
  - _Crafting Edges · Prereq: Basic Balls or Apricorn Balls_
  - You may attempt to fix any Poke Ball that has failed to capture a Pokemon and broke. Make a Technology Check with a DC of 15. If you succeed, the Poke Ball is fixed and is treated as if it had not broken. If you fail, the ball is permanently broken. Requires access to a Poke Ball Tool Box.
...
- 🟢 **Shock Resistance** — `likely` · P3 · themes: damage · code: EDGE_FX:149
  - _Do Porygon Dream of Mareep · Prereq: Novice Technology Education_
  - You don't suffer Augmentation Shock from Electric Type damage unless it is Massive Damage.

- 🟢 **Skill Stunt** — `likely` · P3 · themes: damage, skill · code: categoricBonus:110, openDowsing:30087
...
- 🟢 **Sneak's Tricks** — `likely` · P3 · themes: other · code: EDGE_FX:123
  - _Combat Edges · Prereq: Adept Stealth_
  - You learn the move Astonish.

- 🟢 **Survival Drive** — `likely` · P3 · themes: other · code: EDGE_FX:124
  - _Combat Edges · Prereq: Adept Survival_
  - You learn the move Bulk Up.

- 🟢 **Throwing Masteries** — `likely` · P3 · themes: other · code: EDGE_FX:115
...
- 🟢 **Touched** — `likely` · P3 · themes: other · code: refreshSwarmRounds:44526
